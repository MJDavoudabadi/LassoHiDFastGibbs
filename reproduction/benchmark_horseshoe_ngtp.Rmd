...
```{r}
res_pcg_sb = benchmark_pcg_sigma2_col_vbeta(vy, mX, "horseshoe", lambda_init, sigma2_init, a, b, u, v, nburn, nsamples, trials, beta_inds=res_4BG$beta_inds) 
# print(res_pcg_sb)
```
...
if (requireNamespace("horseshoe", quietly = TRUE)) {
  res_horseshoe = LassoHiDFastGibbs:::benchmark_horseshoe(vy, mX,
                                                          lambda_init, sigma2_init, a, b, u, v, 
                                                          nburn, nsamples, trials=1, 
                                                          beta_inds=res_4BG$beta_inds) 
} else {
  stop("Skipping horseshoe benchmark: package 'horseshoe' is not installed.")
}
...
if (requireNamespace("bayeslm", quietly = TRUE)) {
  res_bayeslm = LassoHiDFastGibbs:::benchmark_horseshoe_bayeslm(vy, mX,
                                                                lambda_init, sigma2_init, a, b, u, v, 
                                                                nburn, nsamples, trials, 
                                                                beta_inds=res_4BG$beta_inds) 
} else {
  stop("Skipping bayeslm horseshoe benchmark: package 'bayeslm' is not installed.")
}
...
if (requireNamespace("brms", quietly = TRUE)) {
  res_brms = LassoHiDFastGibbs:::benchmark_horseshoe_brms(vy, mX,
                                                          lambda_init, sigma2_init, a, b, u, v, 
                                                          nburn, nsamples, trials=1, 
                                                          beta_inds=res_4BG$beta_inds) 
} else {
  stop("Skipping brms benchmark: package 'brms' is not installed.")
}
...
if (requireNamespace("bayesreg", quietly = TRUE)) {
  res_bayesreg = LassoHiDFastGibbs:::benchmark_horseshoe_bayesreg(vy, mX,
                                                                  lambda_init, sigma2_init, a, b, u, v, 
                                                                  nburn, nsamples, trials, 
                                                                  beta_inds=res_4BG$beta_inds) 
} else {
  stop("Skipping bayesreg horseshoe benchmark: package 'bayesreg' is not installed.")
}
...
save(res_4BG,
     ...
     res_horseshoe,
     res_brms,
     file = file.path(results_dir, paste0(dataset_name,"_horseshoe_results_ngtp.Rdata")))
```
