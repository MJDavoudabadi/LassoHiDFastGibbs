---
title: "Benchmark blasso (p > n) horseshoe prior"
...
if (requireNamespace("Mhorseshoe", quietly = TRUE)) {
  ...
  stop("Skipping Mhorseshoe benchmark: package 'Mhorseshoe' is not installed.")
}
# print(res_EHS)
```
...
save(res_4BG,
     ...
     res_EHS,
     res_AHS,
     file = file.path(results_dir, paste0(dataset_name,"_horseshoe_results_pgtn.Rdata")))
```
